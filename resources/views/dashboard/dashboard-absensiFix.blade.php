...
<div class="dashboard-content">
    ...
    {{-- Holder statistik utama --}}
    <div class="content-card">
        <div class="content-card-header">
            <h3 class="content-title">Statistik Kehadiran</h3>
    ...
    <div class="content-card mt-4">
        <div class="content-card-header">
            <h3 class="content-title">Izin Bulan Ini</h3>
        </div>

        <div class="izin-card">
            <div class="izin-header">
                <span class="izin-title">📋 Total Izin</span>
            </div>
    ...
    <div class="content-card mt-4">
        <div class="content-card-header">
            <h3 class="content-title">
                Ringkasan Bulan <span id="bulan-saat-ini">Januari</span> <span id="tahun-saat-ini">2025</span>
            </h3>

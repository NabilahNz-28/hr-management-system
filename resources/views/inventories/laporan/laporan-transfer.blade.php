...
<div class="container-fluid">
            ...
            <form action="{{ route('inventory.laporan-transfer') }}" method="GET">
                <div class="row g-3 align-items-end">
                    ...
                    <div class="col-xl-2 col-lg-4 col-md-6">
                        <label class="form-label" style="font-size: 13px; font-weight: 600; color: #475569; margin-bottom: 6px;">Status</label>
                        <select class="form-select" name="status" style="border-radius: 8px; border: 1px solid #cbd5e1; padding: 8px 36px 8px 12px; font-size: 13.5px; min-height: 42px; line-height: 1.5;">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex justify-content-between align-items-center">
            <h6 class="m-0 font-weight-bold text-primary">Riwayat Invoice Transfer Stock</h6>
        </div>
        <div class="card-body">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td data-label="Produk">
                                ...
                                <div style="font-size: 12px; color: #64748b; margin-top: 4px; max-width: 240px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;" title="{{ $inv['produk_names'] }}">
                                    {{ $inv['produk_names'] }}
                                </div>
                            </td>
                            ...
                            <td data-label="Status">
                                ...
                                @elseif(strtolower($st) === 'dibatalkan')
                                    <span class="badge" style="padding: 5px 12px; border-radius: 20px; background: #fee2e2; color: #dc2626; font-size: 12px; font-weight: 600;">{{ $st }}</span>
                                @else
                            ...
                            <td data-label="" class="text-center" style="position: relative;">
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end shadow" style="border-radius: 8px; border: 1px solid #e2e8f0; z-index: 1050;">
                                        <li>
                                            <a class="dropdown-item d-flex align-items-center" href="#" data-bs-toggle="modal" data-bs-target="#modalTransferDetail{{ $index }}" style="font-size: 13px; padding: 8px 16px;">
                                ...
                                <div class="modal fade text-start" id="modalTransferDetail{{ $index }}" tabindex="-1" aria-hidden="true">
                                        ...
                                        <div class="modal-content" style="border-radius: 14px; overflow: hidden; border: none; box-shadow: 0 20px 25px -5px rgba(0,0,0,0.1);">
                                            <div class="modal-header" style="background: #1e293b; color: #ffffff; padding: 16px 24px;">
                                                <h5 class="modal-title" style="font-size: 16px; font-weight: 600;">
                                                    Detail Transfer — {{ $inv['invoice_no'] }}
                                                </h5>
                                            ...
                                            <div class="modal-body p-4" style="background: #f8fafc;">
                                                <div class="mb-3 d-flex justify-content-between align-items-center">
                                                    ...
                                                    <div>
                                                        <span class="badge" style="background: #f1f5f9; color: #334155; padding: 6px 14px; border-radius: 20px; font-size: 12px;">{{ $st }}</span>
                                                    </div>
                                                </div>
                        ...
                        <tr>
                            <td colspan="10" class="text-center" style="padding: 40px; color: #94a3b8;">
                                Belum ada data invoice transfer.
                            </td>
                        </tr>
                        @endforelse
                    </tbody>

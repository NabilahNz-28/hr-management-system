...
<div id="sidebar">
    <div class="sidebar-header">
        <div class="brand-text" style="line-height: 1.2;">Absensi Karyawan</div>
        @if(auth()->check() && (auth()->user()->role === 'pic' || auth()->user()->role === 'superadmin'))
        <a href="{{ route('dashboard.pic') }}" class="btn-beralih-sidebar" title="Beralih ke Dashboard Inventory">
            <span>Beralih</span>
        ...
        <div class="menu-section">
            ...
            <a href="{{ route('laporan.cuti') }}"
               class="menu-item {{ request()->routeIs('laporan.cuti') ? 'active' : '' }}">
                ...
                <div class="menu-text">Riwayat Izin &amp; Cuti</div>
            </a>
	        </div>

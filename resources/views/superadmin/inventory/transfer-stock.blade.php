...
<div class="dashboard-content">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p style="color: #64748b; font-size: 14px; margin: 0;">Rekap riwayat invoice transfer stock antar gudang dari seluruh PIC</p>
        </div>
    </div>
                ...
                <table class="table table-hover mb-0" width="100%" cellspacing="0" style="font-size: 13.5px;">
                    <thead style="background: #f8fafc; color: #475569; border-bottom: 1px solid #e2e8f0;">
                        <tr>
                            ...
                            <th class="py-3 px-3">Gudang Asal</th>
                            <th class="py-3 px-3">Ke Gudang</th>
                            <th class="py-3 px-3">Total Jumlah</th>
                    ...
                    <tbody>
                        ...
                        <tr style="border-bottom: 1px solid #f1f5f9; vertical-align: middle;">
                            ...
                            <td class="px-3">
                                ...
                                <div style="font-size: 12px; color: #64748b; margin-top: 4px; max-width: 200px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;" title="{{ $inv['produk_names'] }}">
                                    {{ $inv['produk_names'] }}
                                </div>
                            </td>
                            ...
                            <td class="px-3">
                                ...
                                @elseif($inv['status'] === 'Dibatalkan')
                                    <span class="badge" style="background: #fee2e2; color: #ef4444; padding: 6px 12px; border-radius: 20px; font-weight: 600;">Dibatalkan</span>
                                @else
                                            ...
                                            <div class="modal-body p-4" style="background: #f8fafc;">
                                                <div class="mb-3 d-flex justify-content-between align-items-center">
                                                    ...
                                                    <div>
                                                        ...
                                                        @elseif($inv['status'] === 'Dibatalkan')
                                                            <span class="badge" style="background: #fee2e2; color: #ef4444; padding: 6px 14px; border-radius: 20px; font-size: 12px;">Dibatalkan</span>
                                                        @else
                                                            <span class="badge" style="background: #fef9c3; color: #ca8a04; padding: 6px 14px; border-radius: 20px; font-size: 12px;">{{ $inv['status'] }}</span>
                                                        @endif
                                                    </div>
                                                </div>
                        ...
                        @empty
                        <tr>
                            <td colspan="11" class="text-center" style="padding: 40px; color: #94a3b8;">
                                Belum ada data invoice transfer stock.
                            </td>
                        </tr>
                        @endforelse
                    </tbody>
